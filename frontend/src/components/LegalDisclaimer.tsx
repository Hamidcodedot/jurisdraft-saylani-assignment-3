...
export const LegalDisclaimer: React.FC<LegalDisclaimerProps> = ({ compact = false }) => {
  if (compact) {
    return (
      <div className="flex items-center justify-between gap-2 px-3 py-1.5 bg-amber-50/80 border border-amber-200/80 rounded-md text-[11px] text-amber-900">
        ...
        <Link 
          href="/disclaimer" 
          className="underline hover:text-amber-950 font-medium whitespace-nowrap ml-2"
        >
          Disclaimer &rarr;
        </Link>
      </div>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="text-xs leading-relaxed space-y-1.5 flex-1">
          ...
          <div className="pt-1">
            ...
            >
              <span>Read our full Entity Classification &amp; Legal Disclaimer</span>
